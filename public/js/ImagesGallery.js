window.ImageGallery = (function () {
  class ImageGallery {
    ...
    _onUserSearch(ev) {
      ev.preventDefault();
      this.search(this.seachInput.value, this.selectSearchModule.value);
    }
    ...
    _initView() {
      ...
      this.selectSearchModule.className = "gallery__search form-control form-control__select";
      this.formGroup.appendChild(this.selectSearchModule);
